...
from api.routes import forecast, auth, tickers, metrics
...
def create_app() -> FastAPI:
    ...
    app.state.allow_legacy_prophet = config.get("api", {}).get("allow_legacy_prophet", True)
    ...
    try:
        ...
        redis_client = None
    app.state.ticker_service = TickerService(supabase_client, redis_client, 3600) if supabase_client else None
